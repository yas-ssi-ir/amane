    ...
    return [
        {
            ...
            # Si OOD : afficher "Peau saine" avec confiance élevée
            "ai_prediction": "Peau saine" if c.ai_is_ood else c.ai_prediction,
            "ai_confidence": 0.95 if c.ai_is_ood else c.ai_confidence,
            "ai_risk_level": "LOW" if c.ai_is_ood else c.ai_risk_level,
            "ai_is_ood": c.ai_is_ood or False,
...
def get_consultation(
    ...
    return {
        ...
        "ai_result": {
            ...
            "primary_diagnosis": "Peau saine" if c.ai_is_ood else c.ai_prediction,
            "confidence": 0.95 if c.ai_is_ood else c.ai_confidence,
            "risk_level": "LOW" if c.ai_is_ood else c.ai_risk_level,
